...
export default function AndroidPage() {
  const categoryProducts = products.filter(p => p.category === 'Android');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-brand-section py-20 border-b border-brand-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Android Flagships</h1>
            <p className="text-lg text-brand-text-secondary max-w-2xl mx-auto">
              Explore Samsung, OnePlus, Pixel, Vivo, Oppo, Xiaomi, Nothing, Motorola, and iQOO smartphones.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-2 ml-4">
                <span className="px-4 py-1.5 bg-brand-accent/10 text-brand-accent rounded-full text-sm font-medium cursor-pointer">All Brands</span>
                <span className="px-4 py-1.5 border border-brand-border rounded-full text-sm font-medium cursor-pointer hover:bg-brand-section">Samsung</span>
              </div>
            </div>
          ...
          {sortedProducts.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white rounded-3xl border border-brand-border">
              <h3 className="text-xl font-semibold mb-2">No Android devices found</h3>
