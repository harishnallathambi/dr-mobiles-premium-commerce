...
export default function Home() {
  ...
  const ipads = products.filter(p => p.category === 'iPad').slice(0, 4);
      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-brand-bg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-10">
              ...
              <a href="/shop" className="text-brand-accent hover:underline font-medium">View All</a>
            </div>
        ...
        <section className="py-20 bg-brand-bg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-10">
              <div>
                <h2 className="text-3xl font-bold tracking-tight mb-2">iPad & Tablets</h2>
                <p className="text-brand-text-secondary">Power, portability, and endless possibilities.</p>
              </div>
              <a href="/shop" className="text-brand-accent hover:underline font-medium">View All</a>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
